...
// ref: https://www.youtube.com/watch?v=FHphOv2mmIA
...
// runtime 64ms (82.47%) and 34.5MB (82.57%) used
function twoSum(nums, target) {
	let arr = new Array();

	for (let i = 0; i < nums.length; i++) {
		if (arr[target - nums[i]] >= 0) { // match
